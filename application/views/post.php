<div class="center-align">
    ...
    <div id="left-column-blog">
        ...
        <figure class="images-blog-site-center"><img src="<?php print base_url(); ?>assets/images/chuteiras-adidas.jpg"></figure>

        <h2>Líderes de mercado, Adidas e Nike inovam e lançam chuteiras 'cano alto' para a Copa</h2>

        <h3>As duas principais marcas de artigos esportivos ao redor do mundo lançaram nesta quinta-feira uma nova moda. Inovadoras, Nike e Adidas exibiram seus modelos de chuteiras com uma novidade pouco comum para o fã de futebol.</h3>
        ...
        <figure class="images-blog-site-left"><img src="<?php print base_url(); ?>assets/images/nike-magista.jpg" alt="Nike Magista"></figure>
        ...
        <h3>FONTE: New York Times</h3>
    </div>

    <div id="right-column-blog">
        <h2>PUBLICIDADE</h2>
        <div class="publicidade-blog"><a href=""><img src="<?php print base_url(); ?>assets/images/banner.jpg" alt="Banner"></a></div>
        <div class="publicidade-blog"><a href=""><img src="<?php print base_url(); ?>assets/images/banner.jpg" alt="Banner"></a></div>
        <div class="publicidade-blog"><a href=""><img src="<?php print base_url(); ?>assets/images/banner.jpg" alt="Banner"></a></div>
    </div>
